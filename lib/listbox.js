...
export class ListBox {
    constructor(root, title = `${root.ariaLabel}`) {
        ...
        _ListBox_shortcutsConfig.set(this, {
            selection: {
                forword: KeyboardShortcut.create(`${this.title} - forword selection`, `Shift${KeyboardShortcut.separatorShortcuts}ArrowDown`, [this.root]).ondown(() => __awaiter(this, void 0, void 0, function* () {
                    this.forwordSelection(1);
                })),
                backword: KeyboardShortcut.create(`${this.title} - backword selection`, `Shift${KeyboardShortcut.separatorShortcuts}ArrowUp`, [this.root]).ondown(() => __awaiter(this, void 0, void 0, function* () {
        ...
        this.root.ondragend = __classPrivateFieldGet(this, _ListBox_drag_function, "f");
    ...
    static title(title, type) {
        var S = __classPrivateFieldGet(this, _a, "f", _ListBox_all).find(({ title: tlt }) => title == tlt);
        return S ? S : null;
    }
}
