...
var _a, _ListBox_selection_direction, _ListBox_effective_hist_elements, _ListBox_all, _ListBox_pointer_down_function, _ListBox_click_function, _ListBox_drag_function;
...
export class ListBox {
    constructor(root, title = `${root.ariaLabel}`) {
        ...
        _ListBox_effective_hist_elements.set(this, []);
        this.rowname = '';
        this.configurations = {
            movable: true,
            scrolling: true,
    ...
    get ELEMENT_DIRECTION() {
        return __classPrivateFieldGet(this, _ListBox_selection_direction, "f") == 'forword' ? this.LAST_ELEMENT_SELECT : this.FIRST_ELEMENT_SELECT;
    }
    set drag(v) {
        v = Boolean(v);
    ...
    setShow(element, flag) {
        ...
        if (!flag) {
            if (this.getEffective(element))
                __classPrivateFieldGet(this, _ListBox_effective_hist_elements, "f").push(element);
            this.setEffective(element, false);
        }
        else {
            var index = __classPrivateFieldGet(this, _ListBox_effective_hist_elements, "f").indexOf(element);
            if (index >= 0) {
                __classPrivateFieldGet(this, _ListBox_effective_hist_elements, "f").splice(index, 1);
...
_a = ListBox, _ListBox_selection_direction = new WeakMap(), _ListBox_effective_hist_elements = new WeakMap(), _ListBox_pointer_down_function = new WeakMap(), _ListBox_click_function = new WeakMap(), _ListBox_drag_function = new WeakMap();
_ListBox_all = { value: [] };
