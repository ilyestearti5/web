...
export class ListBox {
    constructor(root, title = `${root.ariaLabel}`) {
        ...
        _ListBox_shortcutsConfig.set(this, void 0);
        this.rowString = "row";
        ...
        _ListBox_pointer_down_function.set(this, (e) => {
            ...
            if (!mainElement)
                return;
            if (e.altKey)
                __classPrivateFieldGet(this, _ListBox_configurations, "f").scrolling &&
        ...
        _ListBox_click_function.set(this, (e) => {
            ...
            focusElement && __classPrivateFieldGet(this, _ListBox_instances, "m", _ListBox_submit).call(this, "click", focusElement);
        });
        ...
        __classPrivateFieldSet(this, _ListBox_shortcutsConfig, {
            selection: {
                forword: KeyboardShortcut.create(`${__classPrivateFieldGet(this, _ListBox_title, "f")} - forword selection`, `Shift${KeyboardShortcut.separatorShortcuts}ArrowDown`, [this.root]).ondown(() => {
                    this.forwordSelection(1);
                }),
                backword: KeyboardShortcut.create(`${__classPrivateFieldGet(this, _ListBox_title, "f")} - backword selection`, `Shift${KeyboardShortcut.separatorShortcuts}ArrowUp`, [this.root]).ondown(() => {
                    this.backwordSelection(1);
                }),
            },
            move: {
                forword: KeyboardShortcut.create(`${__classPrivateFieldGet(this, _ListBox_title, "f")} - forword`, `ArrowDown`, [this.root]).ondown((combinition, event) => {
                    event && event.preventDefault();
                    this.forword(1);
                }),
                backword: KeyboardShortcut.create(`${__classPrivateFieldGet(this, _ListBox_title, "f")} - backword`, `ArrowUp`, [this.root]).ondown((combinition, event) => {
                    event && event.preventDefault();
                    this.backword(1);
                }),
            },
            status: {
                submit: KeyboardShortcut.create(`${__classPrivateFieldGet(this, _ListBox_title, "f")} - submit`, `Enter`, [
                    this.root,
                ]).ondown(() => {
                    __classPrivateFieldGet(this, _ListBox_instances, "m", _ListBox_submit).call(this, "keypress");
                }),
                cancel: KeyboardShortcut.create(`${__classPrivateFieldGet(this, _ListBox_title, "f")} - cancel`, "Escape", [
                    this.root,
                ]).ondown(() => this.select()),
            },
            clipboard: null,
    ...
    removeTarget(element) {
        ...
        (_b = __classPrivateFieldGet(this, _ListBox_shortcutsConfig, "f").move.forword.targets) === null || _b === void 0 ? void 0 : _b.splice((_c = __classPrivateFieldGet(this, _ListBox_shortcutsConfig, "f").move.forword.targets) === null || _c === void 0 ? void 0 : _c.indexOf(element), 1);
        (_d = __classPrivateFieldGet(this, _ListBox_shortcutsConfig, "f").move.backword.targets) === null || _d === void 0 ? void 0 : _d.splice((_e = __classPrivateFieldGet(this, _ListBox_shortcutsConfig, "f").move.backword.targets) === null || _e === void 0 ? void 0 : _e.indexOf(element), 1);
        (_f = __classPrivateFieldGet(this, _ListBox_shortcutsConfig, "f").selection.forword.targets) === null || _f === void 0 ? void 0 : _f.splice((_g = __classPrivateFieldGet(this, _ListBox_shortcutsConfig, "f").selection.forword.targets) === null || _g === void 0 ? void 0 : _g.indexOf(element), 1);
        (_h = __classPrivateFieldGet(this, _ListBox_shortcutsConfig, "f").selection.backword.targets) === null || _h === void 0 ? void 0 : _h.splice((_j = __classPrivateFieldGet(this, _ListBox_shortcutsConfig, "f").selection.backword.targets) === null || _j === void 0 ? void 0 : _j.indexOf(element), 1);
        (_k = __classPrivateFieldGet(this, _ListBox_shortcutsConfig, "f").status.cancel.targets) === null || _k === void 0 ? void 0 : _k.splice((_l = __classPrivateFieldGet(this, _ListBox_shortcutsConfig, "f").status.cancel.targets) === null || _l === void 0 ? void 0 : _l.indexOf(element), 1);
        (_m = __classPrivateFieldGet(this, _ListBox_shortcutsConfig, "f").status.submit.targets) === null || _m === void 0 ? void 0 : _m.splice((_o = __classPrivateFieldGet(this, _ListBox_shortcutsConfig, "f").status.submit.targets) === null || _o === void 0 ? void 0 : _o.indexOf(element), 1);
    }
...
_a = ListBox, _ListBox_title = new WeakMap(), _ListBox_selection_direction = new WeakMap(), _ListBox_dragging = new WeakMap(), _ListBox_shortcutsConfig = new WeakMap(), _ListBox_configurations = new WeakMap(), _ListBox_on_submit_fn = new WeakMap(), _ListBox_on_change_fn = new WeakMap(), _ListBox_pointer_down_function = new WeakMap(), _ListBox_click_function = new WeakMap(), _ListBox_drag_function = new WeakMap(), _ListBox_instances = new WeakSet(), _ListBox_setConfigurations = function _ListBox_setConfigurations(config) {
    ...
    return true;
}, _ListBox_submit = function _ListBox_submit(type = "click", element = this.ELEMENT_DIRECTION) {
    if (this.SELECT_ELEMENTS.length)
        __classPrivateFieldGet(this, _ListBox_on_submit_fn, "f").forEach((fn) => fn(type, element));
