...
var _KeyboardShortcut_instances, _a, _KeyboardShortcut_main_keys, _KeyboardShortcut_all, _KeyboardShortcut_keyboardKeys, _KeyboardShortcut_on_down_fn, _KeyboardShortcut_on_up_fn, _KeyboardShortcut_main_fn, _KeyboardShortcut_down, _KeyboardShortcut_up, _KeyboardShortcut_activate, _KeyboardShortcut_propertys, _KeyboardShortcut_label, _KeyboardShortcut_change, _KeyboardShortcut_isValide, _KeyboardShortcut_toProp, _KeyboardShortcut_toString, _KeyboardShortcut_create, _KeyboardShortcut_exec, _KeyboardShortcut_execCommand, _KeyboardShortcut_watch, _KeyboardShortcut_keyOf;
export class KeyboardShortcut {
    ...
    constructor(label, propertys) {
        ...
        if (__classPrivateFieldGet(KeyboardShortcut, _a, "f", _KeyboardShortcut_all).some((s) => s.label == label))
        ...
        this.when.down = true;
        __classPrivateFieldGet(KeyboardShortcut, _a, "f", _KeyboardShortcut_all).push(this);
    }
    get activate() {
    ...
    static create(label = "", input = "", targets = null) {
        return __classPrivateFieldGet(this, _a, "m", _KeyboardShortcut_create).call(this, label, input, targets);
    }
    static exec(input, press) {
        return __classPrivateFieldGet(this, _a, "m", _KeyboardShortcut_exec).call(this, input, press);
    }
    ...
    static label(labelName = "") {
        var fd = __classPrivateFieldGet(this, _a, "f", _KeyboardShortcut_all).find((sh) => __classPrivateFieldGet(sh, _KeyboardShortcut_label, "f") == labelName);
        return fd ? fd : null;
    }
    ...
    static get all() {
        return __classPrivateFieldGet(this, _a, "f", _KeyboardShortcut_all);
    }
}
_a = KeyboardShortcut, _KeyboardShortcut_on_down_fn = new WeakMap(), _KeyboardShortcut_on_up_fn = new WeakMap(), _KeyboardShortcut_main_fn = new WeakMap(), _KeyboardShortcut_down = new WeakMap(), _KeyboardShortcut_up = new WeakMap(), _KeyboardShortcut_activate = new WeakMap(), _KeyboardShortcut_propertys = new WeakMap(), _KeyboardShortcut_label = new WeakMap(), _KeyboardShortcut_instances = new WeakSet(), _KeyboardShortcut_change = function _KeyboardShortcut_change(content) {
...
}, _KeyboardShortcut_create = function _KeyboardShortcut_create(label = "", input = "", targets = null) {
    var result = new this(label, this.convertTo(input, "object"));
    result.targets = targets;
    return result;
}, _KeyboardShortcut_exec = function _KeyboardShortcut_exec(input, press) {
    var shortcut = this.convertTo(input, "object");
    var ready = __classPrivateFieldGet(this, _a, "f", _KeyboardShortcut_all).filter((shrt) => shrt.isValide(shortcut));
    ...
    var fd = __classPrivateFieldGet(this, _a, "f", _KeyboardShortcut_all).find(({ label: lab }) => lab == label);
    if (!fd)
        return null;
