...
_a = KeyboardShortcut, _KeyboardShortcut_main_fn = new WeakMap(), _KeyboardShortcut_down = new WeakMap(), _KeyboardShortcut_up = new WeakMap(), _KeyboardShortcut_press = new WeakMap(), _KeyboardShortcut_activate = new WeakMap(), _KeyboardShortcut_propertys = new WeakMap(), _KeyboardShortcut_label = new WeakMap(), _KeyboardShortcut_instances = new WeakSet(), _KeyboardShortcut_change = function _KeyboardShortcut_change(content) {
    ...
    for (let pressType of press) {
        switch (pressType) {
            case 'down': {
                s.onfunctionsdown.forEach(fn => fn(__classPrivateFieldGet(s, _KeyboardShortcut_propertys, "f"), null, 'call'));
                break;
            }
            case 'up': {
                s.onfunctionsup.forEach(fn => fn(__classPrivateFieldGet(s, _KeyboardShortcut_propertys, "f"), null, 'call'));
                break;
            }
            case 'press': {
                s.onfunctionspress.forEach(fn => fn(__classPrivateFieldGet(s, _KeyboardShortcut_propertys, "f"), null, 'call'));
            }
        }
    }
    return s;
