...
var _TreeLinear_instances, _TreeLinear_mainTreeElement, _TreeLinear_callbackQuery, _TreeLinear_treePropertys, _TreeLinear_isLine, _TreeLinear_inner, _TreeLinear_outer, _TreeLinear_toQuery, _TreeLinear_toElement, _TreeLinear_getLevelElement, _TreeLinear_getIconElement, _TreeLinear_isOpend, _TreeLinear_isClosed, _TreeLinear_open, _TreeLinear_close, _TreeLinear_toggle;
...
export class TreeLinear extends Iterations {
    constructor(root, title, propertys, defaultValues) {
        ...
        this.separator = '/';
        _TreeLinear_treePropertys.set(this, []);
    ...
    isTree(element) {
        ...
        return __classPrivateFieldGet(this, _TreeLinear_treePropertys, "f").every(({ property, value }) => columns[this.propertys.indexOf(property)].innerHTML.trim() === `${value}`.trim());
    }
    ...
    setTreePropertys(...propertys) {
        __classPrivateFieldSet(this, _TreeLinear_treePropertys, propertys, "f");
...
_TreeLinear_mainTreeElement = new WeakMap(), _TreeLinear_callbackQuery = new WeakMap(), _TreeLinear_treePropertys = new WeakMap(), _TreeLinear_instances = new WeakSet(), _TreeLinear_isLine = function _TreeLinear_isLine(element) {
