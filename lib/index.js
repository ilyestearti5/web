...
_a = KeyboardShortcut, _KeyboardShortcut_on_down_fn = new WeakMap(), _KeyboardShortcut_on_up_fn = new WeakMap(), _KeyboardShortcut_on_press_fn = new WeakMap(), _KeyboardShortcut_main_fn = new WeakMap(), _KeyboardShortcut_down = new WeakMap(), _KeyboardShortcut_up = new WeakMap(), _KeyboardShortcut_press = new WeakMap(), _KeyboardShortcut_activate = new WeakMap(), _KeyboardShortcut_propertys = new WeakMap(), _KeyboardShortcut_label = new WeakMap(), _KeyboardShortcut_instances = new WeakSet(), _KeyboardShortcut_change = function _KeyboardShortcut_change(content) {
    ...
    if (__classPrivateFieldGet(KeyboardShortcut, _a, "f", _KeyboardShortcut_main_keys).some((k) => typeof __classPrivateFieldGet(this, _KeyboardShortcut_propertys, "f")[k] == "boolean" &&
        ...
        (Array.isArray(__classPrivateFieldGet(this, _KeyboardShortcut_propertys, "f").Keys) &&
            __classPrivateFieldGet(this, _KeyboardShortcut_propertys, "f").Keys.every((value) => { var _f; return !((_f = shortcut.Keys) === null || _f === void 0 ? void 0 : _f.includes(value)); })) ||
...
export class ListBox {
    ...
    flipshortcut(to) {
        ...
        (_f = this.shortcuts.inner) === null || _f === void 0 ? void 0 : _f.open.change(to == "left-right" ? "ArrowDown" : "ArrowRight");
        (_g = this.shortcuts.inner) === null || _g === void 0 ? void 0 : _g.close.change(to == "left-right" ? "ArrowUp" : "ArrowLeft");
    }
...
export class Table extends Iterations {
    ...
    after(element, data, timeout, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            var result = [];
            yield forEachAsync(data.reverse(), (input) => {
                const row = this.createrow(input);
                element.after(row);
                result.unshift(this.readrow(row));
            }, timeout, limit);
    ...
    methode(methode, input, element, timeout, limit) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            switch (methode) {
                ...
                case "before": {
                    result = yield this[methode](element, input, timeout, limit);
                    break;
                }
                case "prepend": {
                }
                case "append": {
                    result = yield this[methode](input, timeout, limit);
                    break;
                }
                case "sort": {
...
export class TreeLinear extends Iterations {
    ...
    createrow(input, lvl = 0, closed = false, visible = true) {
        ...
        if (this.issubtree(result)) {
            ...
            (_f = result.querySelector('[role="level"]')) === null || _f === void 0 ? void 0 : _f.prepend(showMoreIcon);
        }
        else
        ...
        this.ITEMS.forEach((element) => {
            ...
            if (issubtree) {
                if (!iconShowMore) {
                    ...
                    (_f = element.querySelector('[role="level"]')) === null || _f === void 0 ? void 0 : _f.prepend(showMoreIcon);
                }
            }
            else
...
export class Graphe {
    ...
    copy() {
        ...
        __classPrivateFieldSet(this, _Graphe_indexCopyed, (_f = __classPrivateFieldGet(this, _Graphe_indexCopyed, "f"), _f++, _f), "f");
...
export class ToolBar extends ListBox {
    ...
    removeTip(label) {
        var _f;
        (_f = this.findTip(label)) === null || _f === void 0 ? void 0 : _f.element.remove();
    }
    exec(label) {
...
export class Notifications {
    constructor(title, ...inputs) {
        ...
        _Notifications_titleElement.set(this, createElement("div", "", { role: "title-notification" }));
        _Notifications_contentElement.set(this, createElement("div", "", { role: "content-notification" }));
        _Notifications_notifictionElement.set(this, createElement("div", "", {
            role: "notification",
            tabindex: -1,
        }));
        this.title = title;
        __classPrivateFieldSet(this, _Notifications_buttons, new ListBox(createElement("div", "", {}), `notification - ${this.title}`), "f");
        ...
        __classPrivateFieldGet(this, _Notifications_buttons, "f").settargetsshortcuts([__classPrivateFieldGet(this, _Notifications_notifictionElement, "f")]);
        ...
        __classPrivateFieldGet(Notifications, _d, "f", _Notifications_all).add(this);
    }
    get inputs() {
    ...
    open(init = __classPrivateFieldGet(this, _Notifications_inputs, "f").at(-1)) {
        __classPrivateFieldGet(this, _Notifications_buttons, "f").root.innerHTML = __classPrivateFieldGet(this, _Notifications_inputs, "f")
            .map((input) => `<span aria-selected="${init === input}">${input.toString()}</span>`)
            .join("\n");
    ...
    delete() {
        __classPrivateFieldGet(Notifications, _d, "f", _Notifications_all).delete(this);
    }
    static get all() {
        return Array.from(__classPrivateFieldGet(this, _d, "f", _Notifications_all));
    }
}
_d = Notifications, _Notifications_inputs = new WeakMap(), _Notifications_title = new WeakMap(), _Notifications_buttons = new WeakMap(), _Notifications_titleElement = new WeakMap(), _Notifications_contentElement = new WeakMap(), _Notifications_notifictionElement = new WeakMap();
Notifications.mainNotificationElement = createElement("div", "", {
    role: "notifications",
});
...
export class Tree extends Iterations {
    constructor(root, title, propertys, defaultValues) {
        ...
        console.log(this.shortcuts.find);
    ...
    setsubtreepropertys(...propertys) {
        ...
        this.ITEMS.forEach((element) => {
            ...
            if (this.issubtree(element)) {
                ...
                (_f = __classPrivateFieldGet(this, _Tree_instances, "m", _Tree_getinnertreeelement).call(this, element)) === null || _f === void 0 ? void 0 : _f.remove();
            }
        });
    }
    setcallbackquery(callback) {
...
export class Watch {
    constructor(name) {
        ...
        __classPrivateFieldGet(Watch, _e, "f", _Watch_all).push(this);
    }
    get name() {
    ...
    set value(v) {
        __classPrivateFieldGet(this, _Watch_nodes, "f").forEach((ele) => (ele.innerHTML = v));
    ...
    static get all() {
        return [...__classPrivateFieldGet(this, _e, "f", _Watch_all)];
    }
}
_e = Watch, _Watch_value = new WeakMap(), _Watch_nodes = new WeakMap(), _Watch_name = new WeakMap();
_Watch_all = { value: [] };
