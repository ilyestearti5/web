...
var _TreeLinear_instances, _TreeLinear_parentRoot, _TreeLinear_propertys, _TreeLinear_writable, _TreeLinear_hiddenPropertys, _TreeLinear_on_change_function, _TreeLinear_writingShortcut, _TreeLinear_clipboardhistory, _TreeLinear_callbackQuery, _TreeLinear_getWritable, _TreeLinear_setWritable, _TreeLinear_getLevel, _TreeLinear_outerTree, _TreeLinear_innerTree, _TreeLinear_open, _TreeLinear_close, _TreeLinear_toggle, _TreeLinear_isOpend, _TreeLinear_isClosed, _TreeLinear_toQuery, _TreeLinear_toElement, _TreeLinear_append, _TreeLinear_appendSync, _TreeLinear_after, _TreeLinear_afterSync, _TreeLinear_before, _TreeLinear_beforeSync, _TreeLinear_insertSync, _TreeLinear_insert, _TreeLinear_childs, _TreeLinear_methode, _TreeLinear_methodeSync, _TreeLinear_delete;
...
export class TreeLinear extends ListBox {
    constructor(root, title, propertys, defProp) {
        ...
        _TreeLinear_clipboardhistory.set(this, []);
    ...
    get clipboardHistory() {
        return __classPrivateFieldGet(this, _TreeLinear_clipboardhistory, "f");
    }
    getWritable() {
    ...
    copy() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            __classPrivateFieldGet(this, _TreeLinear_clipboardhistory, "f").push({ content: json, event: "copy" });
        });
    }
    paste() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            last
                ? __classPrivateFieldGet(this, _TreeLinear_instances, "m", _TreeLinear_insert).call(this, last, 130, 2, ...array)
            ...
            __classPrivateFieldGet(this, _TreeLinear_clipboardhistory, "f").push({ content: array, event: "paste" });
        });
    }
    cut() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield navigator.clipboard.writeText(JSON.stringify(content, undefined, 1));
            ...
            __classPrivateFieldGet(this, _TreeLinear_clipboardhistory, "f").push({ content, event: "cut" });
        });
    }
    columns(propertys) {
...
_TreeLinear_parentRoot = new WeakMap(), _TreeLinear_propertys = new WeakMap(), _TreeLinear_writable = new WeakMap(), _TreeLinear_hiddenPropertys = new WeakMap(), _TreeLinear_on_change_function = new WeakMap(), _TreeLinear_writingShortcut = new WeakMap(), _TreeLinear_clipboardhistory = new WeakMap(), _TreeLinear_callbackQuery = new WeakMap(), _TreeLinear_instances = new WeakSet(), _TreeLinear_getWritable = function _TreeLinear_getWritable() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        var result = [];
        yield forEachAsync(__classPrivateFieldGet(this, _TreeLinear_instances, "m", _TreeLinear_innerTree).call(this, element), (ele) => __awaiter(this, void 0, void 0, function* () { return result.push(...(yield __classPrivateFieldGet(this, _TreeLinear_instances, "m", _TreeLinear_delete).call(this, ele))); }), 4, 1);
        element.remove();
        result.push(element);
        return result;
    });
